...
1. **프로젝트 클론**
```bash
git clone https://github.com/your-username/Skindiagnosis.git
cd Skindiagnosis
```
...
`SkindiagnosisApp.swift`에서 모드 변경 가능:
...
- Issues: [GitHub Issues](https://github.com/your-username/Skindiagnosis/issues)
